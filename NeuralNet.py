...
class NeuralNetwork:
    ...
    def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
        for iteration in range(number_of_training_iterations):
            ...
            output_from_layer_1, output_from_layer_2, output_from_layer_3, output_from_layer_4\
            ...
            # Calculate the error for layer 3 (By looking at the weights in layer 3,
            # we can determine by how much layer 3 contributed to the error in layer 4).
    ...
    def print_weights(self):
        ...
        print("    Layer 2 (4 neurons, each with 3 inputs): ")
        print(self.layer2.synaptic_weights)
        print("    Layer 3 (4 neurons, each with 3 inputs): ")
...
if __name__ == "__main__":
    ...
    # Create layer 1, 2, 3 (4 neurons, each with 3 inputs)
    layer1 = NeuronLayer(4, 3)
    layer2 = NeuronLayer(4, 3)
    layer3 = NeuronLayer(4, 3)

    # Create layer 4 (a single neuron with 4 inputs)
